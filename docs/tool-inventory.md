...
| languages | node | 26.5.0 | node-dist | dotfiles-runtime | upstream-checksum |
| languages | npm | 12.0.1 | npm | node-runtime | npm-registry |
| languages | typescript | 7.0.2 | npm | npm | npm-registry |
| languages | python | 3.14.6 | uv | uv | uv-managed |
| languages | java | 25.0.3+9 | github | dotfiles-runtime | pinned-sha256 |
...
| cloud | aws_cli | 2.36.7 | direct | vendor-installer | pinned-sha256 |
...
| cloud | kubecolor | 0.6.0 | github | dotfiles-binary | upstream-checksum |
...
| ai_tools | omp | 18.0.5 | github | dotfiles-binary | pinned-sha256 |
...
| ai_tools | pix_optimizer | 1.1.26 | npm | omp-plugin | npm-registry |
