...
|---------|------|---------|--------|
| core | fzf | 0.62.0 | external |
| core | fd | 10.2.0 | apt |
| core | ripgrep | 14.1.1 | apt |
| core | bat | 0.25.0 | apt |
| core | eza | 0.21.0 | apt_repo |
| core | lazygit | 0.51.1 | github |
| core | btop | 1.4.0 | apt |
| core | starship | 1.23.0 | install_script |
| core | jq | latest | apt |
| core | yq | latest | apt |
| core | htop | latest | apt |
| core | zoxide | 0.9.3 | apt |
| core | direnv | 2.32.1 | apt |
| core | git-delta | 0.16.5 | apt |
...
| editor | neovim | 0.11.1 | github |
| cloud | docker | latest | apt_repo |
| cloud | kubectl | 1.32.0 | direct |
| cloud | helm | 3.17.0 | install_script |
| cloud | terraform | 1.12.0 | direct |
| cloud | ansible | latest | pip |
| cloud | k9s | 0.40.5 | github |
